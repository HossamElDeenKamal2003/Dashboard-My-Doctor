...
const { signUp, login, updatePassword, forgetPassword, sendVerificationForgetPass, checkEmail, patchBlock,handleToken, sendVerification, verifyCode, patchAlerts } = require('../../controller/userController/userController');
